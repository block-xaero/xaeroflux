...
pub struct GroupLimits<const MAX_WORKSPACES: usize, const MAX_TOTAL_PEERS: usize, const MAX_OBJECTS_PER_WORKSPACE: usize, const MAX_PEERS_PER_WORKSPACE: usize> {
...
pub struct GroupStateMachine<const MAX_WORKSPACES: usize, const MAX_PEERS: usize, const OBJECT_SIZE: usize, const MAX_WORKSPACE_PEERS: usize> {
